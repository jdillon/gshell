...
public interface LoggingSystem
{
    ...
    // TODO: Add components (to provide access to appenders/filters/renderers, whatever the underlying system exposes)
    //       include properties and methods.  Needs a name and a type (both strings)
}